    ...
    function update() {
        ...
        setTimeout(function() {
            ...
            data.innerHTML =
                ...
                '}' +
                '</style>' +
                "<div style='animation: rotate 1s ease-in-out 0s infinite backwards; border: " + loaderScreenWidth + "px solid rgb(255,255,255" + loaderScreenOpacity + "); border-top-color: rgba(0, 51, 255, " + loaderScreenOpacity + "); border-radius: 50%; height: 75px; margin: 0 auto; margin-bottom: " + loaderScreenMargin + "px; width: 75px'> </div>";
